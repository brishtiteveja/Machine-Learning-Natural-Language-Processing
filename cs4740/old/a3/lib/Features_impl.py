...
try:
  os.makedirs(data_path+'data/features/')
except:
  pass
...
class PrefixSuffixFeature():
    ...
    def __init__(self,cache_file=data_path+'data/features/prefix_suffix.dat'):
        try:
...
class WordFeature():
    ...
    def __init__(self,cache_file=data_path+'data/features/words.dat'):
        try:
            with open(cache_file,'r') as f:
                words = pickle.load(f)
